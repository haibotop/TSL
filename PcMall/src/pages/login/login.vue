    ...
    <div>
        ...
        <div id="login">
            <div class="login-title">
                <div class="login-t">会员 <span class="xiegang"></span> 登录</div>
            </div>
            <div class="login-content">
                ...
                <div class="login-cont" v-show="!loginStatus">
                    <div class="phoneNum">
                        <span>手机号</span>
                        <Input @keyup.enter.native="loginBtn" onkeyup="value=value.replace(/[^0-9]/g,'')" v-model="account" ref="numInput" placeholder="请输入您的手机号码" :maxlength=11  @on-change="handlePhone" />
                    </div>
                    <div class="password">
                        <span>密码</span>
                        <Input @keyup.enter.native="loginBtn" v-model="password" ref="pwdInput" type="password" placeholder="请输入您的密码" />
                    </div>
