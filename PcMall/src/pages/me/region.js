export var regionList = [
  ...
  {
    name: '四川省', cityList: [
      { name: '成都市', areaList: ['市辖区', '锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江区', "双流区", '金堂县', '郫县', '大邑县', '蒲江县', '新津县', '都江堰市', '彭州市', '邛崃市', '崇州市', "简阳市"] },
      ...
      { name: '宜宾市', areaList: ['市辖区', '翠屏区', '南溪区', '宜宾县', '江安县', '长宁县', '高县', '珙县', '筠连县', '兴文县', '屏山县'] },
  ...
  },
  {
    name: '河南省', cityList: [
      ...
      { name: '开封市', areaList: ['市辖区', '龙亭区', '顺河回族区', '鼓楼区', '禹王台区', '金明区', '祥符区', '杞县', '通许县', '尉氏县', '兰考县'] },
  ...
  },
  {
    name: '广西壮族自治区', cityList: [
      ...
      { name: '梧州市', areaList: ['市辖区', '万秀区', '龙圩区', '长洲区', '苍梧县', '藤县', '蒙山县', '岑溪市'] },
  ...
  {
    name: '陕西省', cityList: [
      { name: '西安市', areaList: ['市辖区', '新城区', '碑林区', '莲湖区', '灞桥区', '未央区', '雁塔区', '阎良区', '临潼区', '长安区', '蓝田县', '周至县', '户县', '高陵区'] },
      { name: '铜川市', areaList: ['市辖区', '王益区', '印台区', '耀州区', '宜君县'] },
      { name: '宝鸡市', areaList: ['市辖区', '渭滨区', '金台区', '陈仓区', '凤翔县', '岐山县', '扶风县', '眉县', '陇县', '千阳县', '麟游县', '凤县', '太白县'] },
      { name: '咸阳市', areaList: ['市辖区', '秦都区', '杨陵区', '渭城区', '三原县', '泾阳县', '乾县', '礼泉县', '永寿县', '彬县', '长武县', '旬邑县', '淳化县', '武功县', '兴平市'] },
      { name: '渭南市', areaList: ['市辖区', '临渭区', '华州区', '潼关县', '大荔县', '合阳县', '澄城县', '蒲城县', '白水县', '富平县', '韩城市', '华阴市'] },
      { name: '延安市', areaList: ['市辖区', '宝塔区', '延长县', '延川县', '子长县', '安塞区', '志丹县', '吴起县', '甘泉县', '富县', '洛川县', '宜川县', '黄龙县', '黄陵县'] },
      { name: '汉中市', areaList: ['市辖区', '汉台区', '南郑县', '城固县', '洋县', '西乡县', '勉县', '宁强县', '略阳县', '镇巴县', '留坝县', '佛坪县'] },
      { name: '榆林市', areaList: ['市辖区', '榆阳区', '横山区', '神木县', '府谷县', '靖边县', '定边县', '绥德县', '米脂县', '佳县', '吴堡县', '清涧县', '子洲县'] },
  ...
  {
    name: '河北省', cityList: [
      { name: '石家庄市', areaList: ['市辖区', '长安区', '桥西区', '新华区', '井陉矿区', '裕华区', '藁城区', '鹿泉区', '栾城区', '井陉县', '正定县', '行唐县', '灵寿县', '高邑县', '深泽县', '赞皇县', '无极县', '平山县', '元氏县', '赵县', '晋州市', '新乐市'] },
      { name: '唐山市', areaList: ['市辖区', '路南区', '路北区', '古冶区', '开平区', '丰南区', '丰润区', '曹妃甸区', '滦县', '滦南县', '乐亭县', '迁西县', '玉田县', '遵化市', '迁安市'] },
      ...
      { name: '保定市', areaList: ['市辖区', '竞秀区', '莲池区', '满城区', '清苑区', '徐水区', '涞水县', '阜平县', '定兴县', '唐县', '高阳县', '容城县', '涞源县', '望都县', '安新县', '易县', '曲阳县', '蠡县', '顺平县', '博野县', '雄县', '涿州市', '安国市', '高碑店市'] },
  ...
  },
  {
    name: '江西省', cityList: [
      ...
      { name: '赣州市', areaList: ['市辖区', '章贡区', '南康区', '赣县', '信丰县', '大余县', '上犹县', '崇义县', '安远县', '龙南县', '定南县', '全南县', '宁都县', '于都县', '兴国县', '会昌县', '寻乌县', '石城县', '瑞金市'] },
  ...
  },
  {
    name: '山东省', cityList: [
      ...
      { name: '荷泽市', areaList: ['市辖区', '牡丹区', '定陶去', '曹县', '单县', '成武县', '巨野县', '郓城县', '鄄城县', '东明县'] }
    ]
  },
  {
    name: '辽宁省', cityList: [
  ...
  },
  {
    name: '黑龙江省', cityList: [
      ...
      { name: '佳木斯市', areaList: ['市辖区', '向阳区', '前进区', '东风区', '区', '桦南县', '桦川县', '汤原县', '抚远市', '同江市', '富锦市'] },
