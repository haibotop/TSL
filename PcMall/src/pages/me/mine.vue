    ...
    <group gutter="0px">
      ...
      <div class="order-status-tab">
        <div @click="goOrders(1)">
            <!--<img src="../../assets/icons/waitPay.svg" style="display:block;margin:5px auto;width:27px;" alt="" >-->
            <span>待付款</span>
        </div>
        <div @click="goOrders(2)">
            <!--<img src="../../assets/icons/waitSend.svg" style="display:block;margin:5px auto;width:27px;" alt="" >-->
            <span>待发货</span>
        </div>
        <div @click="goOrders(3)">
            <!--<img src="../../assets/icons/waitGet.svg" style="display:block;margin:5px auto;width:27px;" alt="" >-->
            <span>待收货</span>
        </div>
        <div @click="goOrders(4)">
            <!--<img src="../../assets/icons/afterSell.svg" style="display:block;margin:5px auto;width:27px;" alt="" >-->
            <span>已完成</span>
        </div>
        <div @click="goOrders(-1)">
            <!--<img src="../../assets/icons/aftersales-temp.svg" style="display:block;margin:5px auto;width:27px;opacity:0.4;" alt="" >-->
            <span>售后</span>
        </div>
      </div>
    </group>
