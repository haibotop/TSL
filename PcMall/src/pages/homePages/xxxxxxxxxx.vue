                ...
                <CarouselItem> -->
                    ...
                    <div class="carousel-content">
                        <ul>
                            <li v-for="(item, index) in pList" :key="index" >
                                <div class="pic" @click="goPd(item.defaultSkuId)">
                                    <img :src="item.defaultPicture" :alt="handleName(item.skuName)" width="70%" >
                                </div>
                                <div>
                        ...
                        <!-- <ul>
                            <li >
                                <div class="pic">
                                    <img src="../../../static/ppp.jpg" width="70%" alt="">
                                </div>
                                <div>
                                    <p class="explain">黄金项链女款萌宠镂空本命生肖狗足金吊坠套链子</p>
                                    <p class="price">￥4.009</p>
                                    <p class="price_">￥1.009</p>
                                </div>
                            </li>                           
                        </ul> -->
